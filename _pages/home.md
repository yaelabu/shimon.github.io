...
<div markdown="0" id="carousel" class="carousel slide" data-ride="carousel" data-interval="4000" data-pause="hover" >
    ...
    <div class="carousel-inner" markdown="0">
        ...
        <div class="item">
            <img src="{{ site.url }}{{ site.baseurl }}/images/slider7001400/SignalPropQuantizationRings.png" alt="Slide 4" /> [Paper](https://arxiv.org/abs/1906.00771)
        </div>
        <div class="item">
            <img src="{{ site.url }}{{ site.baseurl }}/images/slider7001400/ContinualLearning.png" alt="Slide 5" /> [Paper](https://arxiv.org/abs/2306.03534)
        </div>
        <div class="item">
            <img src="{{ site.url }}{{ site.baseurl }}/images/slider7001400/GDChaos.png" alt="Slide 6" /> [Paper](https://arxiv.org/abs/2305.13064)
        </div>
     </div>
